...
1. Login flow (admin, teacher, student)
2. Verify RTL/LTR switching works correctly
3. Test cascade delete (no 400 errors)
4. Test mobile responsive layout
5. Verify no Tiptap console warnings
6. Test comments functionality (if collections available)
7. Test materials viewing (check for 400 errors)
8. Test settings updates (school name)

**After Browser Verification:**
1. Commit any test data or documentation changes
2. Push to remote branch
3. Trigger Netlify redeploy for production
4. Run final verification on production domain
5. Address any remaining issues from test report

### Files Changed This Session
- `backend/pb_migrations/1775280000_fix_api_rules.js` - DELETED (was causing migration failure)
- `journal.md` - Updated with session notes (this entry)
...
- [ ] Test all 5 major fixes in browser
- [ ] Verify cascade delete works without errors
